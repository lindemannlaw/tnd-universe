...
return [
    ...
    'media_replace_failed' => 'Η αντικατάσταση του αρχείου απέτυχε',
    'media_delete_failed' => 'Η διαγραφή του αρχείου απέτυχε',
    'media_orphan' => 'Αυτό το αρχείο είναι ορφανό (δεν υπάρχει γονικό στοιχείο). Η αντικατάσταση δεν είναι δυνατή.',
];
